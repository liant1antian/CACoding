...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
            ...
            SignupUserDataAccessInterface userDataAccessObject, ClearViewModel clearViewModel, ClearUserDataAccessInterface clearUserDataAccessInterface) {
    ...
    private static ClearController createUserClearUseCase(ViewManagerModel viewManagerModel, ClearViewModel clearViewModel,
                                                          SignupViewModel signupViewModel, ClearUserDataAccessInterface clearUserDataAccessInterface) throws IOException {
        ...
        ClearInputBoundary userClearInteractor = new ClearInteractor(clearUserDataAccessInterface,clearOutputBoundary,userFactory);
